...
public val MyIcon.IcTrash2Solar: ImageVector
    get() {
        ...
        _icTrash2Solar = Builder(name = "IcTrash2Solar", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveToRelative(15.333f, 2.5f)
                lineToRelative(-0.46f, 6.9f)
                curveToRelative(-0.177f, 2.654f, -0.265f, 3.981f, -1.13f, 4.79f)
...
private var _icTrash2Solar: ImageVector? = null
